export interface DependencyGraph { nodes: string[]; edges: Record<string, string[]>; }

export function calculateSecurityBlastRadius(graph: DependencyGraph, affectedNode: string): number {
