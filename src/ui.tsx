...
const ICONS = {
  ...
  github: (<><circle cx="12" cy="12" r="9" /><path d="M9.5 20v-3a2.5 2.5 0 01.5-1.6c-2.2-.3-4-1.4-4-4.4a3.4 3.4 0 01.8-2.3 3.2 3.2 0 010-2.4s.8-.2 2.6 1a9 9 0 014.2 0c1.8-1.2 2.6-1 2.6-1a3.2 3.2 0 010 2.4 3.4 3.4 0 01.8 2.3c0 3-1.8 4.1-4 4.4a2.5 2.5 0 01.5 1.6v3" /></>),
